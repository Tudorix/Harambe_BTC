...
public class HardwareClass {
    ...
    public double IN = -20, MAX = 1500;
    public double CLOSE = 300;
    public DistanceSensor IntakeSensor;

    //Servo
    public Servo ClawIn , ClawOut , IntakeRotate, OuttakeRotate, MobiDick , Cam, Pivot;
    public CRServo Sweep;
    // Intake claw
   public double SPEC_CLAW_OPEN = 0.25 ,SPEC_CLAW_CLOSE = 0.5;
    public double PIVOT_MAX_RIGHT = 0.48 , PIVOT_RIGHT = 0.32, PIVOT_LEFT_TOP = 0.1 , PIVOT_PERPENDICULAR = 0.54;
    public double PIVOT_MAX_LEFT = 0.16 ;
    public double CAM_OUT = 0.47 ,CAM_IN = 0.13;


    public double MD_OUT = 1 ,MD_IN = 0;
    // Intake rotation
    public double INTAKE_ROTATION_DOWN = 0.2 , INTAKE_ROTATION_UP = 0.8  , INTAKE_ROTATION_PREP = 0.35,INTAKE_ROTATION_SEE = 0.39;
    public double OUTTAKE_ROTATION_TAKE = 0.3, OUTTAKE_ROTATION_PLACE = 0.7, OUTTAKE_ROTATION_VERTICAL = 0.7 , OUTTAKE_ROTATION_SPEC = 0.9   , OUTTAKE_ROTATION_HIGH_VERT = 0.62,OUTTAKE_ROTATION_TAKE_LOW = 0.04;
    ...
    public HardwareClass(HardwareMap hardwareMap){
        ...
        this.IntakeSensor = hardwareMap.get(DistanceSensor.class,"HATZ");
    }
